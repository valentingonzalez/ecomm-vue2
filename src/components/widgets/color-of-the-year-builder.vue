...
import ColorOfTheYear from '@/components/widgets/color-of-the-year';

export default {
  name: 'ColorOfTheYearBuilder',
  props: {
    id: {
      default: null
    },
  ...
  methods: {
    remove() {
      this.$swal({
        title: 'Remove Two Columns Widget',
        html: `Are you sure you want to remove the Two Columns Widget?`,
        type: 'warning',
