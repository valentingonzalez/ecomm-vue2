<template>
  <div class="container page-wrapper pl-4 pr-4 pt-4">
    ...
    <div class="responsive-frame mb-5">
      <img src="https://storage.googleapis.com/content.ezadtv.com/2020/08/05/5f2b17800e2a3_banner_weber.png"/>
    </div>
    <div class="row mb-5">
      <div class="col-xs-12 col-lg-6 mb-sm-4">
        <div class="service-image">
          <img src="https://storage.googleapis.com/content.ezadtv.com/2020/08/05/5f2b179ed817e_george_buying.png"/>
        </div>
      </div>
    ...
    <div class="row mb-5">
      ...
      <div class="col-xs-12 col-lg-6">
        <div class="service-image">
          <img src="https://storage.googleapis.com/content.ezadtv.com/2020/08/05/5f2b17ccde43e_evolution_buying.png"/>
        </div>
      </div>
    </div>
    <div class="row mb-5">
...
<script>
  ...
  export default {
    name: 'weber-grills-buying-guide',
    data() {
      return {
        grillProducts: [],
