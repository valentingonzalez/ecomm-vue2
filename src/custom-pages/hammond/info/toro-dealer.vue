<template>
  <div class="page-wrapper">
    <h1 class="page-title">The Only Authorized Toro Service Center In Jackson, MI</h1>
    <div class="mb-4">
    ...
    <div class="row mb-4">
      <div class="col-12">
        <div class="dealer-info">
          <h3 class="text-center mb-0"><img class="authorized-icon" src="images/info_pages/authorized_toro_icon.png"/>Jackson County's Authorized Toro Dealer For Toro Lawn Mowers & Snow Blowers </h3>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div @click="heroesRedirection" class="col-xs-12 col-lg-6 cursor-pointer">
          <div class="banner-wrapper">
            <div class="banner-image">
              <img src="images/info_pages/businessman_echo.png"/>
            </div>
        ...
        <div @click="secretSauceRedirection"  class="col-xs-12 col-lg-6 cursor-pointer">
          <div class="banner-wrapper border-0 banner-two">
            <div class="banner-image">
              <img src="images/info_pages/fuel_station_echo.png"/>
            </div>
            <div class="banner-info">
    ...
    <div class="row mb-5">
      <div class="col-xs-12 col-lg-6">
        <div class="service-image">
          <img src="images/info_pages/toro_lawn_hero.jpg"/>
        </div>
      </div>
      <div class="col-xs-12 col-lg-6">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      moveToMowersPage() {
        this.$router.push("/info/best-lawn-mowers-for-sale-near-me-jackson-mi");
      },
      moveToExternalLink() {
        window.open("https://401791.go.toro.com/s/showcase/168/toro/4174/", '_blank');
      },
      secretSauceRedirection() {
        this.$router.push("/info/get-the-secret");
      },
      heroesRedirection() {
        this.$router.push("/info/small-engine-repair");
      }
    },
    async mounted() {
      this.fetchProducts();
