<template>
  <div class="page-wrapper">
    ...
    <div class="responsive-frame mb-4">
      <img style="width: 100% !important;" src="images/info_pages/surecan-header.jpg"/>
    </div>
    ...
    <div class="row mb-5">
      <div class="col-xs-12 col-lg-9 mb-sm-4">
        <div class="responsive-frame mb-4">
          <img src="images/info_pages/surecan-pic.jpg"/>
        </div>
      </div>
    ...
    <div class="row mb-5">
      <div class="col-xs-12 col-lg-6 mb-sm-4">
        <div class="responsive-frame mb-4">
          <img src="images/info_pages/surecan-pic-2.jpg"/>
        </div>
      </div>
      <div class="col-xs-12 col-lg-6">
        <div class="responsive-frame mb-4">
          <img src="images/info_pages/surecan-pic-3.jpg"/>
        </div>
      </div>
    </div>
